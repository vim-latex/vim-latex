...
" Description:
function! latexsuite#filebrowser#FB_OpenFileBrowser(dir)
...
function! latexsuite#filebrowser#FB_DisplayFiles(dir)
	if !isdirectory(a:dir)
		return
	endif
...
" Description:
function! latexsuite#filebrowser#FB_SetVar(varname, value)
